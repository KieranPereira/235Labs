...
// MPU addresses
MPU6050 imuBack(0x69);  // lower-back IMU, AD0→GND
MPU6050 imuNeck(0x68);  // neck IMU,     AD0→VCC



// Vibration-driver pins & channels
static constexpr int BACK_L_PWM = 32;   // back-left motor PWM (roll < -TH) (Works!)
static constexpr int BACK_R_PWM = 12;   // back-right motor PWM (roll > +TH) (Works!)
...
static constexpr int   PWM_DUTY   = 255;     // 0–255
